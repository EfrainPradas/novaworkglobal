                    ...
                    {tools.slice(1).map((tool) => { // Skip the first tool (AI Job Search) since it's now embedded above
                        ...
                        return (
                            <div
                                ...
                                className={`group relative p-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:border-primary-200 dark:hover:border-primary-900 hover:shadow-lg transition-all duration-300 cursor-pointer flex flex-col ${tool.className || ''}`}
                            >
