...
export default function HeadhunterSearch() {
  ...
  const { t } = useTranslation()
    ...
    const externalLists = [
        { name: t('headhunterSearch.forbes', "Forbes: America's Best Recruiting Firms"), url: "https://www.forbes.com/lists/best-executive-recruiting-firms/", desc: t('headhunterSearch.forbesDesc', 'Top executive search firms ranking.') },
        { name: t('headhunterSearch.huntScanlon', 'Hunt Scanlon Top 50'), url: "https://huntscanlon.com/top-50/", desc: t('headhunterSearch.huntScanlonDesc', 'Leading recruiters ranking.') },
        { name: t('headhunterSearch.clearlyRated', "ClearlyRated's Best of Staffing"), url: "https://www.clearlyrated.com/staffing", desc: t('headhunterSearch.clearlyRatedDesc', 'Client-rated staffing agencies.') }
    ]
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 dark:bg-gray-900 pb-20 transition-colors duration-200">
            <div className="max-w-7xl mx-auto px-6 py-10 space-y-8">
                ...
                {/* Header */}
                <div>
                    <BackButton to="/dashboard/job-search-hub" label={t('headhunterSearch.backToJobSearch', 'Back to Job Search')} className="mb-6 pl-0" />
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-3">
                        ...
                        {t('headhunterSearch.title', 'Leverage Recruiters')}
                    </h1>
                    <p className="text-gray-600 dark:text-gray-400 max-w-2xl text-lg">
                        {t('headhunterSearch.subtitle', "Don't wait to be found. Proactively connect with the gatekeepers of your industry.")}
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 transition-colors duration-200">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{t('headhunterSearch.strategyTitle', 'Strategy: The Company is the Client')}</h2>
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="flex-1 space-y-4">
                            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                {t('headhunterSearch.strategyDesc', "Recruiters work for companies, not candidates. To get on their radar, you need to show them you solve their client's problem.")}
                            </p>
                        ...
                        <div className="bg-orange-50 dark:bg-orange-900/10 p-6 rounded-xl max-w-md w-full">
                            <h4 className="font-bold text-orange-900 dark:text-orange-200 mb-2 flex items-center gap-2">
                                <Filter className="w-4 h-4" /> {t('headhunterSearch.proTipTitle', 'Pro Tip: Filtering')}
                            </h4>
                            <p className="text-sm text-orange-800 dark:text-orange-300 mb-4">
                                {t('headhunterSearch.proTipDesc', 'Use LinkedIn\'s "All Filters" and set Industry to "Staffing and Recruiting" to find external headhunters, or look for "Talent Acquisition" for internal HR.')}
                            </p>
                            <button
                            ...
                            >
                                <Linkedin className="w-4 h-4" /> {t('headhunterSearch.tryLinkedInFilter', 'Try LinkedIn Filter')}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 flex flex-col transition-colors duration-200">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 flex-grow">
                            {t('headhunterSearch.findRecruitersDesc', 'Generate a targeted LinkedIn search for recruiters in your industry.')}
                        </p>
                        <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-xl border border-gray-200 dark:border-gray-600">
                            <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-2">{t('headhunterSearch.industryLabel', 'Your Industry / Role')}</label>
                            ...
                            <p className="text-xs text-center text-gray-400 dark:text-gray-500 mt-2">{t('headhunterSearch.opensLinkedIn', 'Opens LinkedIn in new tab')}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 flex flex-col transition-colors duration-200">
                        <div className="flex items-center gap-3 mb-4 text-blue-600 dark:text-blue-400">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t('headhunterSearch.topFirmRankings', 'Top Firm Rankings')}</h3>
                        </div>
                        <p className="text-gray-600 dark:text-gray-400 mb-6">
                            {t('headhunterSearch.topFirmRankingsDesc', 'Browse reputable lists of search firms to identify targets.')}
                        </p>
