            ...
            <div className="bg-primary-50 dark:bg-primary-900/10 rounded-xl p-6 border border-primary-100 dark:border-primary-900/30">
              ...
              <div className="space-y-4">
                {categories.filter(c => {
                  ...
                  <div key={c.id} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border-l-4 border-primary-400">
                    <div className="flex items-center gap-2 mb-2">
                      <span>{c.icon}</span>
                      <h3 className="font-semibold text-gray-900 dark:text-white">{c.title}</h3>
                      <span className="ml-auto text-xs font-bold bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 px-2 py-1 rounded">
            ...
            <div className="bg-primary-50 dark:bg-primary-900/10 rounded-xl p-6 border border-primary-100 dark:border-primary-900/30">
              ...
              <div className="space-y-4">
                {categories.filter(c => {
                  ...
                  <div key={c.id} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border-l-4 border-primary-300">
                    <div className="flex items-center gap-2 mb-2">
                      <span>{c.icon}</span>
                      <h3 className="font-semibold text-gray-900 dark:text-white">{c.title}</h3>
                      <span className="ml-auto text-xs font-bold bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 px-2 py-1 rounded">
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          {/* Weight Legend */}
          <div className="bg-primary-50 dark:bg-primary-900/10 border border-primary-200 dark:border-primary-900/30 rounded-lg p-4 transition-colors">
        ...
        {/* Integration Note */}
        <div className="mt-6 bg-primary-50 dark:bg-primary-900/10 border border-primary-200 dark:border-primary-900/30 rounded-lg p-4 text-center">
          <p className="text-sm text-gray-700 dark:text-gray-300">
            <Sparkles className="inline w-4 h-4 text-primary-600 dark:text-primary-400 mr-1" />
