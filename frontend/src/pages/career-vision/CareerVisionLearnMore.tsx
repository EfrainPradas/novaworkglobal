    ...
    <div className="min-h-screen bg-white dark:bg-[#030711] font-sans text-[#10223e] dark:text-slate-200 transition-colors duration-300">
      ...
      <div className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-slate-950/70 border-b border-[rgba(11,36,80,0.06)] dark:border-white/5">
        <div className="max-w-[1100px] mx-auto flex items-center justify-between px-6 py-4">
          ...
          >
            <ArrowLeft className="w-4 h-4" /> {t('careerVisionLearnMore.backToCareerVision')}
          </button>
        </div>
      </div>
      ...
      <div className="hero-gradient-cv">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4">
              <a href="#pillars" className="px-8 py-4 rounded-2xl bg-[#0b2450] text-white font-bold shadow-lg hover:bg-[#143a72] transition-all">
                {t('careerVisionLearnMore.exploreFramework')}
              </a>
            </div>
          </div>
        </header>
        ...
        <section className="max-w-[1100px] mx-auto pt-4 pb-8 px-6 text-center">
          <div className="relative group">
            ...
            <img
              ...
              alt={t('careerVisionLearnMore.infographicAlt')}
        ...
        <section id="pillars" className="max-w-[1100px] mx-auto py-20 px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-[#0b2450] dark:text-white mb-3">{t('careerVisionLearnMore.twoPillarsTitle')}</h2>
            <p className="text-[#5a6b86] dark:text-slate-400 text-lg max-w-2xl mx-auto">{t('careerVisionLearnMore.twoPillarsSubtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="cv-card rounded-2xl overflow-hidden border-2 border-[#0b2450] dark:border-blue-700 shadow-lg">
              <div className="bg-[#0b2450] text-white px-6 py-4 flex items-center gap-3">
                ...
                <span className="text-lg font-bold">{t('careerVisionLearnMore.skillsAndKnowledge')}</span>
              </div>
              <div className="bg-white dark:bg-slate-900/50 p-8">
                <p className="text-[#5a6b86] dark:text-slate-400 mb-6 text-lg">{t('careerVisionLearnMore.skillsFocus')}</p>
                <div className="space-y-3">
                  {[
                    { label: t('careerVisionLearnMore.listCompetencies'), desc: t('careerVisionLearnMore.listCompetenciesDesc') },
                    { label: t('careerVisionLearnMore.leverageAI'), desc: t('careerVisionLearnMore.leverageAIDesc') },
                    { label: t('careerVisionLearnMore.financeExamples'), desc: t('careerVisionLearnMore.financeExamplesDesc') },
                  ].map((item) => (
            ...
            <div className="cv-card rounded-2xl overflow-hidden border-2 border-[#06b6d4] dark:border-cyan-600 shadow-lg">
              <div className="bg-[#06b6d4] text-white px-6 py-4 flex items-center gap-3">
                ...
                <span className="text-lg font-bold">{t('careerVisionLearnMore.yourInterests')}</span>
              </div>
              <div className="bg-white dark:bg-slate-900/50 p-8">
                <p className="text-[#5a6b86] dark:text-slate-400 mb-6 text-lg">{t('careerVisionLearnMore.interestsFocus')}</p>
                <div className="space-y-3">
                  {[
                    { label: t('careerVisionLearnMore.enjoyableSkills'), desc: t('careerVisionLearnMore.enjoyableSkillsDesc') },
                    { label: t('careerVisionLearnMore.aspirationalInterests'), desc: t('careerVisionLearnMore.aspirationalInterestsDesc') },
                    { label: t('careerVisionLearnMore.interestAlignment'), desc: t('careerVisionLearnMore.interestAlignmentDesc') },
                  ].map((item) => (
        ...
        <section className="max-w-[1100px] mx-auto py-16 px-6 border-t border-[rgba(11,36,80,0.05)]">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-[#0b2450] dark:text-white tracking-tight mb-4">{t('careerVisionLearnMore.howItWorksTitle')}</h2>
            <p className="text-lg text-[#5a6b86] dark:text-slate-400">{t('careerVisionLearnMore.howItWorksSubtitle')}</p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="cv-card grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8 bg-white dark:bg-slate-900/50 rounded-[32px] p-8 border border-[rgba(11,36,80,0.06)] dark:border-white/5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-[#0b2450] dark:text-white mb-3">{t('careerVisionLearnMore.step1Title')}</h3>
                <p className="text-[#5a6b86] dark:text-slate-400 mb-6">{t('careerVisionLearnMore.step1Desc')}</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    t('careerVisionLearnMore.skill1'),
                    t('careerVisionLearnMore.skill2'),
                    t('careerVisionLearnMore.skill3'),
                    t('careerVisionLearnMore.skill4'),
                    t('careerVisionLearnMore.skill5'),
                    t('careerVisionLearnMore.skill6')
                  ].map((skill) => (
            ...
            <div className="cv-card grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8 bg-white dark:bg-slate-900/50 rounded-[32px] p-8 border border-[rgba(11,36,80,0.06)] dark:border-white/5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-[#0b2450] dark:text-white mb-3">{t('careerVisionLearnMore.step2Title')}</h3>
                <p className="text-[#5a6b86] dark:text-slate-400 mb-6">{t('careerVisionLearnMore.step2Desc')}</p>
                <div className="flex items-center gap-4 flex-wrap">
                  ...
                  <div className="bg-[#06b6d4] text-white px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 shadow-md">
                    <Sparkles className="w-4 h-4" /> {t('careerVisionLearnMore.generateAI')}
                  </div>
                  <div className="space-y-2">
                    {[
                      t('careerVisionLearnMore.aiSuggestion1'),
                      t('careerVisionLearnMore.aiSuggestion2'),
                      t('careerVisionLearnMore.aiSuggestion3')
                    ].map((s) => (
            ...
            <div className="cv-card grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8 bg-white dark:bg-slate-900/50 rounded-[32px] p-8 border border-[rgba(11,36,80,0.06)] dark:border-white/5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-[#0b2450] dark:text-white mb-3">{t('careerVisionLearnMore.step3Title')}</h3>
                <p className="text-[#5a6b86] dark:text-slate-400 mb-6">{t('careerVisionLearnMore.step3Desc')}</p>
                <div className="flex gap-4">
                  {[
                    { label: t('careerVisionLearnMore.skillsAndKnowledge'), color: '#0b2450', items: [t('careerVisionLearnMore.skill1'), t('careerVisionLearnMore.skill2'), t('careerVisionLearnMore.skill3')] },
                    { label: t('careerVisionLearnMore.interests'), color: '#0b2450', items: [t('careerVisionLearnMore.skill1'), t('careerVisionLearnMore.newAspiration')] }
                  ].map((col) => (
                    <div key={col.label} className="flex-1 rounded-xl overflow-hidden border border-[rgba(11,36,80,0.06)] dark:border-white/5 shadow">
                      ...
                      {col.items.map((item) => (
                        <div key={item} className={`px-4 py-2.5 text-sm font-semibold border-b border-[rgba(11,36,80,0.05)] dark:border-white/5 ${item.startsWith('+') ? 'bg-[#06b6d4] text-white' : 'bg-white dark:bg-slate-900 text-[#0b2450] dark:text-slate-300'}`}>
                          {item.startsWith('+') ? t('careerVisionLearnMore.newAspiration') : item}
                        </div>
                      ))}
                    </div>
                  ))}
        ...
        <section className="max-w-[1100px] mx-auto py-16 px-6 border-t border-[rgba(11,36,80,0.05)]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="bg-white dark:bg-slate-900/50 rounded-[32px] p-10 border border-[rgba(11,36,80,0.06)] dark:border-white/5 shadow-xl">
              <h2 className="text-3xl font-black text-[#0b2450] dark:text-white mb-2">{t('careerVisionLearnMore.readyToLaunchTitle')}</h2>
              <p className="text-[#5a6b86] dark:text-slate-400 mb-8">{t('careerVisionLearnMore.readyToLaunchSubtitle')}</p>
              <div className="space-y-5">
                {[
                  t('careerVisionLearnMore.checkpoint1'),
                  t('careerVisionLearnMore.checkpoint2'),
                  t('careerVisionLearnMore.checkpoint3'),
                ].map((item) => (
              ...
              <div className="border-t border-[rgba(11,36,80,0.08)] dark:border-white/10 pt-6 mt-6">
                <p className="font-black text-[#0b2450] dark:text-white text-center">
                  {t('careerVisionLearnMore.readyToLaunchFinal')}
                </p>
              </div>
            </div>

            <div className="text-center lg:text-left">
              <h3 className="text-3xl font-black text-[#0b2450] dark:text-white mb-4">{t('careerVisionLearnMore.whatHappensNextTitle')}</h3>
              <p className="text-[#5a6b86] dark:text-slate-400 mb-6 leading-relaxed">
                {t('careerVisionLearnMore.whatHappensNextDesc')}
              </p>
              <div className="space-y-3">
                {[
                  { icon: '🎯', label: t('careerVisionLearnMore.step1Label'), desc: t('careerVisionLearnMore.step1Desc') },
                  { icon: '📋', label: t('careerVisionLearnMore.step2Label'), desc: t('careerVisionLearnMore.step2Desc') },
                  { icon: '⚙️', label: t('careerVisionLearnMore.step3Label'), desc: t('careerVisionLearnMore.step3Desc') },
                ].map((item) => (
        ...
        <section className="max-w-[800px] mx-auto py-24 px-6 text-center">
          <div className="bg-gradient-to-br from-[#0b2450] to-[#143a72] rounded-[40px] p-12 text-white shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-4xl font-black mb-6 relative z-10">{t('careerVisionLearnMore.ctaTitle')}</h2>
            <p className="text-lg text-white/80 mb-10 relative z-10">
              {t('careerVisionLearnMore.ctaDescription')}
            </p>
            <button
            ...
            >
              {t('careerVisionLearnMore.ctaButton')}
            </button>
          </div>
        </section>
      </div>
      ...
      <footer className="py-12 border-t border-[rgba(11,36,80,0.05)] dark:border-white/5 text-center text-[#5a6b86] dark:text-slate-500 text-sm font-medium">
        &copy; {new Date().getFullYear()} NovaWork Global • {t('careerVisionLearnMore.footerTagline')}
      </footer>
    </div>
  )
}
