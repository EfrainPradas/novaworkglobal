                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="lg:col-span-2">
                            <div className="relative h-[500px] flex items-center justify-center">
                                <svg width="700" height="500" viewBox="0 0 700 500" className="mx-auto">
                                    {/* Skills Circle (Left - Dark Blue) */}
                                    <circle
                                        cx="250"
                                        cy="250"
                                        r="180"
                                        className="fill-blue-900/15 dark:fill-blue-900/30 stroke-blue-900 dark:stroke-blue-400 transition-colors duration-200"
                                        strokeWidth="3"
                                    />

                                    {/* Interests Circle (Right - Orange/Gold) */}
                                    <circle
                                        cx="450"
                                        cy="250"
                                        r="180"
                                        className="fill-orange-600/15 dark:fill-orange-600/20 stroke-orange-600 dark:stroke-orange-400 transition-colors duration-200"
                                        strokeWidth="3"
                                    />
                                    ...
                                    <ellipse
                                        ...
                                        rx="100"
                                        ry="120"
                                        className="fill-indigo-800/90 dark:fill-indigo-900/90 stroke-indigo-800 dark:stroke-indigo-500"
                                        strokeWidth="2"
                                    />
                        ...
                        <div className="lg:col-span-1 space-y-4">
                            ...
                            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                                ...
                                No es solo análisis técnico; es la aplicación de inteligencia de datos para
                                desarrollar personas y soluciones sostenibles.
                            </p>
