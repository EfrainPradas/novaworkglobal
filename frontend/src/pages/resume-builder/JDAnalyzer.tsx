          ...
          {analysis && (
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-4">
              ...
              <div className="flex flex-col gap-4 pt-5 border-t">
                <div className="flex items-center gap-4 bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg border border-gray-100 dark:border-gray-700">
                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Resume Format:</span>
                  <label className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 cursor-pointer hover:text-primary-600 transition-colors">
                    <input
                      type="radio"
                      name="resumeFormat"
                      value="chronological"
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-6 py-3 border-2 border-primary-600 text-primary-600 rounded-lg hover:bg-primary-50 dark:hover:bg-gray-700 font-medium transition-colors"
                  >
